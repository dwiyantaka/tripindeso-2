...
<div>
    ...
    <tr>
        ...
        <td><?php if (($value['proses'])==0) { echo "Belum diproses";} 
                  elseif (($value['proses'])==1) { echo "Sedang diproses";}
                  elseif (($value['proses']==2)) { echo "Sudah diproses";}
            ?>
        </td>
        <td>
            <a href="proses.php?id= <?php echo $value['no_order']?> ">Proses</a>
        </td>
    </tr>
        <?php endforeach; ?>
    </table>
